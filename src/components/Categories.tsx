      ...
      <div className="max-w-[1100px] mx-auto px-4">
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:flex lg:flex-wrap justify-center gap-x-8 lg:gap-x-0 gap-y-8">
          {[
            ...
            { name: 'Labels', icon: 'https://i.ibb.co.com/PvbtDxXf/labels.png', path: '#' },
            { name: 'Magnets', icon: 'https://i.ibb.co.com/LhvTv3dv/magnets.png', path: '#' },
            { name: 'Buttons', icon: 'https://i.ibb.co.com/JW7DWdJh/buttons.png', path: '#' },
            { name: 'Packaging', icon: 'https://i.ibb.co.com/FkxSdt7B/packaging.png', path: '#' },
            { name: 'Apparel', icon: 'https://i.ibb.co.com/wrjF6ynr/apparel.png', path: '#' },
            { name: 'Acrylics', icon: 'https://i.ibb.co.com/4ndRCLBY/acrylics.png', path: '#' },
          ].map((cat) => (
