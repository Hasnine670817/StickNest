...
export default function Magnets() {
  ...
  const faqs = [
    ...
    'Are your custom magnets weatherproof?'
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen">
        ...
        <div className="max-w-[1000px] mx-auto flex flex-col md:flex-row items-center gap-10 md:gap-16">
          ...
          <div className="md:w-1/2 text-center md:text-left">
            ...
            <p className="text-[#555555] text-[15px] sm:text-[16px] leading-[1.6]">
              Custom magnets are the fastest and easiest way to promote your business, product, or event – and Our Store is the easiest way to buy custom magnets. We'll make beautiful vinyl custom magnets from any artwork, logo, or photo. Order your custom magnets in seconds and receive free online proofs, free worldwide shipping and super fast turnaround.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* <section className="py-20 px-4 sm:px-8 bg-[#f4f4f4] text-center">
        <div className="max-w-[800px] mx-auto">
          <h2 className="text-[28px] font-bold text-[#333333] mb-10">Related to custom magnets</h2>
