    ...
    <div className="min-h-screen bg-[#f4f4f4] py-12 px-4 sm:px-8">
      <div className="max-w-[1000px] mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
          ...
          <button className="bg-white border border-gray-300 text-[#333333] px-6 py-2 rounded font-bold hover:bg-gray-50 transition-colors">
            Download Invoice
          </button>
        </div>
                ...
                {order.items.map((item) => (
                  <div key={item.id} className="p-6 flex gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      {item.artwork && (
                        <div className="text-xs bg-gray-50 border border-gray-100 rounded px-2 py-1 inline-block text-gray-600">
